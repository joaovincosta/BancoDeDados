...
--
-- Host: 127.0.0.1
-- Tempo de geração: 06-Ago-2025 às 17:39
...
--
-- Estrutura da tabela `atendimentoservico`
--
...
--
-- Índices para tabela `atendimentoservico`
--
...
--
-- Limitadores para a tabela `atendimentoservico`
--
ALTER TABLE `atendimentoservico`
  ADD CONSTRAINT `atendimentoservico_ibfk_1` FOREIGN KEY (`idatendimento`) REFERENCES `atendimento` (`idatendimento`),
  ADD CONSTRAINT `atendimentoservico_ibfk_2` FOREIGN KEY (`idservico`) REFERENCES `servico` (`idservico`);
