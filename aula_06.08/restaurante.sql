...
--
-- Host: 127.0.0.1
-- Tempo de geração: 12/08/2025 às 00:57
...
CREATE TABLE `arearestaurante` (
  `idarearestaurante` int(11) NOT NULL,
...
CREATE TABLE `mesa` (
  ...
  `idarearestaurante` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `arearestaurante`
  ADD PRIMARY KEY (`idarearestaurante`);
...
ALTER TABLE `mesa`
  ...
  ADD KEY `idarearestaurante` (`idarearestaurante`);
...
--
ALTER TABLE `arearestaurante`
  MODIFY `idarearestaurante` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `atendimento`
  ADD CONSTRAINT `atendimento_ibfk_1` FOREIGN KEY (`idgarcom`) REFERENCES `garcom` (`idgarcom`),
  ADD CONSTRAINT `atendimento_ibfk_2` FOREIGN KEY (`idmesa`) REFERENCES `mesa` (`idmesa`);
...
--
ALTER TABLE `itensconta`
  ADD CONSTRAINT `itensconta_ibfk_1` FOREIGN KEY (`idconta`) REFERENCES `conta` (`idconta`),
  ADD CONSTRAINT `itensconta_ibfk_2` FOREIGN KEY (`iditem`) REFERENCES `item` (`iditem`);

--
-- Restrições para tabelas `mesa`
--
ALTER TABLE `mesa`
  ADD CONSTRAINT `mesa_ibfk_1` FOREIGN KEY (`idarearestaurante`) REFERENCES `arearestaurante` (`idarearestaurante`);
COMMIT;
